@extends('layouts.main', ['title' => 'Add Line'])
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('line_code') is-invalid @enderror"
                                            name="line_code" value="{{ old('line_code') }}" required>
                                        @error('line_code')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('line_name') is-invalid @enderror"
                                            name="line_name" value="{{ old('line_name') }}" required>
                                        @error('line_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
