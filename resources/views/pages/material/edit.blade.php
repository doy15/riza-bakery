@extends('layouts.main', ['title' => 'Edit Material'])
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('type') is-invalid @enderror" name="type"
                                            ...
                                            <option value="raw"
                                                {{ old('type', $material->type) == 'raw' ? 'selected' : '' }}>Raw Material
                                            </option>
                                            <option value="finish_good"
                                                {{ old('type', $material->type) == 'finish_good' ? 'selected' : '' }}>
                                                Finish Good
                                            </option>
                                        </select>
                                        @error('type')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1"
                                            ...
                                            name="minimum_stock"
                                            value="{{ old('minimum_stock', $material->minimum_stock) }}" required>
                                        @error('minimum_stock')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1"
                                            ...
                                            value="{{ old('stock', $material->stock) }}" required>
                                        @error('stock')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                            name="unit" value="{{ old('unit', $material->unit) }}"
                                            placeholder="kg, liter, pcs, unit" required>
                                        @error('unit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
